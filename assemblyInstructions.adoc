...
. Use a *Measuring Tape* and a ** to mark a 50mm cut from the end of the *Aluminum Stock* part. Make sure to leave enough room to make a cut with the *Circular Saw*.
