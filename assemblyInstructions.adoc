...
==== Assemble the Universal Controller Electrical Plug
...
. Using the *Wire Strippers/Cutters*, strip 20mm of insulation off of each end of the *22AWG Wire* length(s) from the above steps.
. Using the *Dupont Crimper*, crimp one *Fork Terminal* onto one end of each of the above *22AWG Wire* length(s).
...
. Preheat the *Soldering Iron* to the temperature recommended on the *Electrical Solder* packaging.
. Use the *Helping Hands* to clamp in place the bare end of one of the remaining *22AWG Wire* length(s).
. Use the tip of the *Soldering Iron* to heat the bare end of the clamped *22AWG Wire* length(s) for a few seconds.
. Apply enough *Electrical Solder* to the contact point of the *Soldering Iron* and the clamped *22AWG Wire* to bind together the strands of bare *22AWG Wire*.
. Remove the *Electrical Solder* and the end of the *Soldering Iron* from the *22AWG Wire*.
. Repeat the above steps for each of the remaining *22AWG Wire* length(s).
...
. Take the *Three Prong Electrical Cord* and strip back 1-2cm of sheathing.
...
. Solder the ends of the remaining exposed hot wires (not ground) to tin them.
