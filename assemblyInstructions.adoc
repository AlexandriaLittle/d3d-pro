...
. Use a *Measuring Tape* and a ** to mark a 50mm cut from the end of the *Aluminum Stock* part. Make sure to leave enough room for the width of the *Metal Cutting Wheel* on the *Circular Saw*.
...
==== Test the wireless printer management software ()
