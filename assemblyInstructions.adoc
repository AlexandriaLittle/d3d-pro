...
. Using the *Ferrule Crimper*, crimp the *Ferrule* part(s) onto each *22AWG Wire*.
. Use the *Wire Strippers/Cutters* to cut off any excess *22AWG Wire* that is poking through the ends of the *Ferrule* part(s).
...
. Zip tie the SSR
. Zip tie the GFCI
. Insert the toggle switch into the side of the case
