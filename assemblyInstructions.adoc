...
. The RAMPS 1.4 Board and Arduino Mega 2560 assembly is complete.
...
==== Assemble the RAMPS Board Assembly to RAMPS Board Assembly 24v Power Custom Wires
...
. The *RAMPS Board Assembly to RAMPS Board Assembly 24v Power Custom Wires* are complete.
...
==== Assemble the RAMPS Board Assembly to Solid State Relay (SSR) 24v Signal Custom Wires
...
. The *RAMPS Board Assembly to Solid State Relay (SSR) 24v Signal Custom Wires* are complete.
