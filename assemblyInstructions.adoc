...
. Using the *Wire Strippers/Cutters*, cut one 200mm long piece of *Red 22AWG Wire* and one 200mm long piece of *Black 22AWG Wire*.
. Use the *Wire Strippers/Cutters* to strip away 20mm of insulation from both ends of the above *22AWG Wire* length(s).
. Use the *Dupont Crimper* to crimp a *Fork Terminal* part(s) to one end of each *22AWG Wire*.
. Preheat the *Soldering Iron* to the temperature recommended on the *Electrical Solder* packaging.
. Use the *Helping Hands* to clamp in place the bare end of one of the *22AWG Wire* length(s).
. Use the tip of the *Soldering Iron* to heat the bare end of the clamped *22AWG Wire* length(s) for a few seconds.
. Apply enough *Electrical Solder* to the contact point of the *Soldering Iron* and the clamped *22AWG Wire* to bind together the strands of bare *22AWG Wire*.
. Remove the *Electrical Solder* and the end of the *Soldering Iron* from the *22AWG Wire*.
. Repeat the above steps for the soldering the remaining *22AWG Wire* length(s).
