...
. Using the *Wire Strippers/Cutters*, cut two (2) 100mm long pieces of *22AWG Wire*.
. Using the *Wire Strippers/Cutters*, strip approximately 1cm of insulation off of both ends of the *22AWG Wire*.
. Place an appropriately sized *Ferrule* onto the end of the stripped *22AWG Wire*.
. Using the *Ferrule Crimper*, crimp the *Ferrule* onto the wire.
. Use the *Wire Strippers/Cutters* to cut off any excess *22AWG Wire* that is poking through the end of the *Ferrule*.
. Repeat the above steps to crimp another *Ferrule* of a different color to the end of the other *22AWG Wire*.
. Using the *Dupont Crimper*, crimp *Dupont Female Pin Connector* part(s) onto the exposed ends of the *22AWG Wire*.
. Insert the both of the *Dupont Female Pin Connector* ends of the *22AWG Wire* into a *2 Pin Female Dupont Connector*.
...
. Using the *Wire Strippers/Cutters, cut two (2) 200mm long pieces of *22AWG Wire*.
. Using the *Wire Strippers/Cutters*, strip approximately 1cm of insulation off of both ends of each of the *22AWG Wire* lengths.
. Place an appropriately sized *Ferrule* onto one end of each of the stripped *22AWG Wire* lengths.
. Using the *Ferrule Crimper*, crimp the *Ferrule* part onto the wire.
. Use the *Wire Strippers/Cutters* to cut off any excess *22AWG Wire* that is poking through the ends of the *Ferrule* part.
. Use the *Dupont Crimper* to crimp on an appropriately sized *Fork Terminal* part(s) to the exposed ends of each *22AWG Wire*.
...
==== Assemble the Two Prong Electrical Plug to 24v Power Supply Module 120v Power Custom Wires
