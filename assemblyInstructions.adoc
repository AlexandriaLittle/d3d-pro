...
==== Assemble the Two Prong Electrical Plug to 24v Power Supply Module/Fast Heated Bed Module 120v Power Custom Wires
...
. Using the *Wire Strippers/Cutters*, strip 20mm of insulation off of each end of the wires from the above steps.
. Using the *Dupont Crimper*, crimp one *Fork Terminal* onto one end of each of the above wires.
. Preheat the *Soldering Iron* to the temperature recommended on the ** packaging.
. Use the *Helping Hands* to clamp in place the bare end of one of the above wires.
. Use the tip of the *Soldering Iron* to heat the bare end of the clamped wire for a few seconds.
. Apply enough ** to the contact point of the *Soldering Iron* and the clamped wire to bind together the strands of bare wire.
. Repeat the above steps for each of the four wires.
. The Two Prong Electrical Plug to 24v Power Supply Module/Fast Heated Bed Module 120v Power Custom Wires are complete.
