...
. Using the *Wire Strippers/Cutters*, cut a 100mm long piece of *22AWG Wire*.
...
. Repeat the above steps to crimp another *Ferrule* of the same color to the other end of the stripped *22AWG Wire*.
. Repeat all of the above steps using different colored *22AWG Wire* and different colored *Ferrule* part so that there are two wires of identical length but distinct appearance.
