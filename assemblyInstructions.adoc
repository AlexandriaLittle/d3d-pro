...
* *A4988 Stepper Motor Driver:* The A4988 Stepper Motor Driver must be oriented correctly when inserted into the , or both components WILL BE DESTROYED when powered on.
