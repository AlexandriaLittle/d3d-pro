...
. Repeat the above step for the other three pairs of *Carbon Fiber Blanket Sleeve* part(s) and *Metal Conduit* part(s).
...
.Take four *M6 Nut* part(s) and screw one onto every screw on the *Fast Heated Bed Top Plate* above the *Fast Heated Bed Bottom Plate*.
