...
. Apply enough ** to the contact point of the *Soldering Iron* and the clamped *22AWG Wire* to bind together the strands of bare *22AWG Wire*.
. Remove the ** and the end of the *Soldering Iron* from the *22AWG Wire*.
